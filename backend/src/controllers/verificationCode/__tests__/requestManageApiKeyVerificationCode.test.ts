...
describe("POST /api/codes/manage-api-key", () => {
  ...
  it("should return 200 on success", async () => {
    ...
    prismaMock.profile.findUnique.mockResolvedValue(
      mockProfileVerified as unknown as Profile,
    );
  ...
  it("should return 404 when the profile has not consented to terms", async () => {
    ...
    prismaMock.profile.findUnique.mockResolvedValue({
      ...mockProfileVerified,
      profileReceipt: {
        ...mockProfileVerified.profileReceipt,
  ...
  it("should return 404 when the profile email has not been verified", async () => {
    mockAuth(prismaMock);
