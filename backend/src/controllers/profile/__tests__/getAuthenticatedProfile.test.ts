...
import { OK, UNAUTHORIZED, BAD_REQUEST } from "@/config/errorCodes";
...
describe("GET /api/profiles/me", () => {
  ...
  it("should return the profile without the password", async () => {
    mockAuth(prismaMock);
    prismaMock.profile.findUnique.mockResolvedValue(mockProfile);
  ...
  it("should return 400 when the profile is not found", async () => {
    mockAuth(prismaMock);
