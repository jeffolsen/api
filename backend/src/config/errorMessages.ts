...
export const MESSAGE_IMAGE_NOT_FOUND = "Image not found";
export const MESSAGE_TAG_NOT_FOUND = "Tag not found";
export const MESSAGE_ITEM_NOT_FOUND = "Item not found";
export const MESSAGE_COMPONENT_NOT_FOUND = "Component not found";
